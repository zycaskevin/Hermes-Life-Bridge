...
def _governed_context() -> str:
    return (
        ...
        "bounded public-news Search/Read through Agent Factory; when supplied, "
        "digital_life_skill_propose may quarantine a generic reusable procedure from the current "
        "conversation for later DLMF/DLD/Agent Factory review. A skill proposal is NOT installed, "
        "active, learned competence, memory, personality, or permission. Tools enable learning and "
